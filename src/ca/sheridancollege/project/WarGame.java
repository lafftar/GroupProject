...
//         3 if they're equal
    ...
    public void warInitiated(WarCard p1Card, WarCard p2Card) {
        ...
        if (player.get(0).getDeck().getSize() < 2 || player.get(1).getDeck().getSize() < 2) {
            this.gameOver = true;
            ...
            while (this.compareCards(p1Card, p2Card) == 2) {
                ...
                for (int i = 0; i < 2; i++) {
                    ...
                    if (i == 1) {
                        ...
                        for (WarPlayer warPlayer : player) {
                            System.out.println(warPlayer + " drew: " + cards.get(player.indexOf(warPlayer)));
                        }
...
//                    + "\n" + this.player2.getName());
        ...
        while (this.player.get(0).getDeck().getSize() > 0 && this.player.get(1).getDeck().getSize() > 0 && !this.gameOver) {
             ...
             and player2.. gave them a room by storing them in arraylists 
             and cleaned it up by printing out all repeating lines of code 
             in for-each loops. Although I did leave all the repeated
             code commented out just in case you wanted to bring them back
             -Bryan
             **/
